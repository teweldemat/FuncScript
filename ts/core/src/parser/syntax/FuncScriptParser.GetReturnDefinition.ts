import { KW_RETURN, ParseContext, ParseNode, ParseNodeType, ParseResult, SyntaxErrorData } from "../FuncScriptParser.Main";
...
export function GetReturnDefinition(context: ParseContext, index: number): ParseResult {
    ...
    parseNode = new ParseNode(ParseNodeType.ReturnExpression, index, i - index, [nodeReturn, exprResult.ParseNode!]);
