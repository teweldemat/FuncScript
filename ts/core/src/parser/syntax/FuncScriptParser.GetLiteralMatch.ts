...
export function GetLiteralMatch(context: ParseContext, index: number, candidate: string): GetLiteralMatchResult {
    return GetLiteralMatchFromString(context.Expression, index, [candidate]);
}

export function GetLiteralMatchMultiple(context: ParseContext, index: number, candidates: string[]): GetLiteralMatchResult {
