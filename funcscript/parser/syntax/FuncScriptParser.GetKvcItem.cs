...
namespace funcscript.core
{
    public partial class FuncScriptParser
    {
        ...
        static GetKvcItemResult GetKvcItem(ParseContext context, int index, bool allowKeyOnly)
        {
            KvcExpression.KeyValueExpression item = null;
            var result = GetKeyValuePair(context, index, allowKeyOnly);
            ...
            if (simpleStringResult.NextIndex > index)
            {
                item = new KvcExpression.KeyValueExpression
                {
                    ...
                    ValueExpression =
                        new ReferenceBlock(simpleStringResult.Str, simpleStringResult.Str.ToLower(), false)
                        {
                            CodePos = index,
